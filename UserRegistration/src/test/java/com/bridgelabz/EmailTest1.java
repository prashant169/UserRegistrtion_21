...
import java.util.List;
    ...
    public class EmailTest1 {
        ...
        @Test
        public void givenEmail1_null_ShouldThrowUserRegistrationException() throws UserRegistrationException {
            UserRegistration userRegistration = new UserRegistration();
            userRegistration.email(null);
        }

        @Test
        public void givenEmail1_EMPTY_ShouldThrowUserRegistrationException() throws UserRegistrationException {
            UserRegistration userRegistration = new UserRegistration();
